...
# for me, this is "D:/Santino/EkipaFanihy/MorphoRev/fig4update/Mada-Bat-Morphology"
setwd(paste0(homewd,"/Fig4"))
bat<- read.csv(paste0(homewd,"/morph_paper_dat_7_29_2021.csv"), header=T, stringsAsFactors = F)
head(bat)
...
FFP<-ggplot() +
  ...
  #scale_x_continuous(breaks = seq(0,361,100),
   #                 labels = c("","", "",""))+
  geom_line(aes(x=new_yday, y=predicted_mod_FF), color="black", size=1,data = pter_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_FF_lci, ymax=predicted_FF_uci), fill="gray50", size=1, alpha=.3,data = pter_dat_juv)
FFP
...
TFP<-ggplot() +
  ...
  coord_cartesian(xlim=c(0,365))+
  geom_line(aes(x=new_yday, y=predicted_mod_TF), color="black", size=1,data = pter_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_TF_lci, ymax=predicted_TF_uci), fill="gray50", size=1, alpha=.3,data = pter_dat_juv)
...
EFP <- ggplot() +
  ...
  geom_line(aes(x=new_yday, y=predicted_mod_EF), color="black", size=1,data = pter_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_EF_lci, ymax=predicted_EF_uci),fill="gray50", size=1, alpha=.3,data = pter_dat_juv)
EFP
...
FFR<-ggplot() +
  ...
  #scale_x_continuous(breaks = seq(0,361,100),
   #                  labels = c("","", "",""))+
  geom_line(aes(x=new_yday, y=predicted_mod_FF), color="black", size=1,data = rou_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_FF_lci, ymax=predicted_FF_uci), fill="grey0", size=1, alpha=.3,data = rou_dat_juv)
FFR
...
TFR<-ggplot() +
  ...
  coord_cartesian(xlim=c(0,365))+
  geom_line(aes(x=new_yday, y=predicted_mod_TF), color="black", size=1,data = rou_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_TF_lci, ymax=predicted_TF_uci), fill="grey0", size=1, alpha=.3,data = rou_dat_juv)
TFR
...
EFR <- ggplot() +
  ...
  geom_line(aes(x=new_yday, y=predicted_mod_EF), color="black", size=1,data = rou_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_EF_lci, ymax=predicted_EF_uci),fill="grey0", size=1, alpha=.3,data = rou_dat_juv)
EFR
...
FFE<-ggplot() +
  ...
  #scale_x_continuous(breaks = seq(0,361,100),
   #                  labels = c("","", "",""))+
  geom_line(aes(x=new_yday, y=predicted_mod_FF), color="black", size=1,data = eid_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_FF_lci, ymax=predicted_FF_uci), fill="grey45", size=1, alpha=.3,data = eid_dat_juv)
FFE
...
TFE<-ggplot() +
  ...
  coord_cartesian(xlim=c(0,365))+
  geom_line(aes(x=new_yday, y=predicted_mod_TF), color="black", size=1,data = eid_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_TF_lci, ymax=predicted_TF_uci), fill="grey45", size=1, alpha=.3,data = eid_dat_juv)
TFE
...
EFE <- ggplot() +
  ...
  geom_line(aes(x=new_yday, y=predicted_mod_EF), color="black", size=1,data = eid_dat_juv)+
  geom_ribbon(aes(x=new_yday, ymin=predicted_EF_lci, ymax=predicted_EF_uci),fill="grey45", size=1, alpha=.3,data = eid_dat_juv)
EFE
...
ggsave(file = paste0(homewd, "/final-figures/eps_tiff/Fig4BW.tiff"),
       units="mm",  
       width=120, 
       height=90, 
       scale=2.5, 
